  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Padding(
        ...
        child: Text(
          'Hello! I\'m Sudeep, a Freelancer based in Raebareli, IN.I enjoy creating things that live on the internet, whether that be applications, websites or anything in between. My goal is always to build products that provide pixel-perfet  experiences.\n\nShortly and currently, I am pursuing my Bachelor\'s degree in Computer Science and Engineering at AKTU, Lucknow, as well as doing freelancing where I work on a wide variety of interesting and meaningful projects on a daily basis.',
